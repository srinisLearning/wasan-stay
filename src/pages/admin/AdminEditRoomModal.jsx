        ...
        <div className="bg-white rounded-lg shadow-xl p-6 max-w-screen-xl">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="flex m-2 justify-end items-center gap-3">
              <button
                type="submit"
                className="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-bold py-3 px-8 rounded-lg shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-105"
              >
                UPDATE ROOM
              </button>
            </div>
